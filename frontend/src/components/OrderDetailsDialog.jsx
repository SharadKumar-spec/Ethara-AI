      ...
      <DialogContent sx={{ py: 3 }}>
        <Grid container spacing={3} sx={{ mb: 4 }}>
          <Grid item xs={12} sm={6}>
            <Typography variant="overline" sx={{ color: 'var(--color-text-secondary)', fontWeight: 600 }}>
              Customer Details
            </Typography>
        ...
        <Typography variant="subtitle1" sx={{ mb: 1.5, fontWeight: 700, color: 'var(--color-text-primary)' }}>
          Items Summary
        </Typography>
          ...
          <Table aria-label="order items table">
            <TableHead sx={{ bgcolor: 'rgba(0,0,0,0.04)' }}>
              <TableRow>
                ...
                <TableCell align="right" sx={{ color: 'var(--color-text-secondary)', fontWeight: 600 }}>Quantity</TableCell>
                <TableCell align="right" sx={{ color: 'var(--color-text-secondary)', fontWeight: 600 }}>Unit Price</TableCell>
                <TableCell align="right" sx={{ color: 'var(--color-text-secondary)', fontWeight: 600 }}>Subtotal</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
